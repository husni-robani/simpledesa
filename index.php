...
if (isset($_POST['username'])) {
	if(cari($_POST['username'],$_POST['password']) == 200){
		...
		echo "<script>alert('User dan Password tidak ditemukan.');document.location = 'indexx.php';</script>";
	}
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Pelayanan Surat Keterangan Online Desa Karyawangi Kabupaten Bandung Barat</title>
    <!-- core CSS -->
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="main/img/logo55.png" width="150" height="54" alt="logo"></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="indexx.php">Login</a></li>
    ...
    <!--/header-->
            ...
            <div class="img-center">
				<img class="img-responsive wow fadeIn" src="main/images/cta2/cta2-img1.png" alt="" data-wow-duration="400ms" data-wow-delay="300ms">
            </div>
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Permohonan di setujui oleh Kepala Desa, kemudian staf akan mencetak surat sesuai request surat yang diajukan, pemohon mengambil surat yang sudah dicetak dan bertandatangan di Kantor Kelurahan Wergu Wetan.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
    ...
    <section id="contact">
        <div>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15846.546304775648!2d107.56418726742356!3d-6.813981800262696!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e17b710882d3%3A0x84cc261281e690d!2sKantor%20Desa%20karyawangi%20Kec.Parongpong%20Kabupaten%20Bandung%20Barat!5e0!3m2!1sen!2sid!4v1672168416034!5m2!1sen!2sid"  width="100%" height="650px" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" alt="lokasi kelurahan"></iframe>
        </div>
    </section>
    <!--/#bottom-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y');?> KANTOR DESA KARYAWANGI KABUPATEN BANDUNG BARAT
                </div>
                <div class="col-sm-6">
