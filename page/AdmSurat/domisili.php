			...
			<div class="content">
				<div class="page-inner">
					...
					<div class="page-header">
						<h4 class="page-title">Surat Keterangan Domisili</h4>
						<div class="ml-md-auto py-2 py-md-0">
								...
								<a href="Report/domisili_rekap.php" target="_BLANK" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> Rekap Data</a>
...
if (isset($_POST['tambah'])) {
	...
	if (mysqli_num_rows($cek) <= 0) {
		...
		$ins = mysqli_query($k,"INSERT INTO tb_surat (jenis_surat,no_surat,nama_surat,tanggal,isi_surat,tanda_tangan,id_warga,createdon,createdby,rowstatus) VALUES ('SKD','$_POST[nomor_surat]','Surat Keterangan Domisili',NOW(),'".gantikutip($isiSurat)."','$xttd','$idd',NOW(),'$_SESSION[nama_pegawai]','1')");
		if ($ins) {
  ...
  var tabel = null;
    ...
    $(document).ready(function() {
        tabel =  $('#basic-datatables').DataTable( {
            ...
            "ajax":
            {
                "url": "Ajax/domisili.php", // URL file untuk proses select datanya
                "type": "POST",
                "data": {
                	"btn":'tabel',
                	"jenis":''
