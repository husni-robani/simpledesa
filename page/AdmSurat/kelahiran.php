			...
			<div class="content">
				<div class="page-inner">
					...
					<div class="page-header">
						<h4 class="page-title">Surat Keterangan Kelahiran</h4>
						<div class="ml-md-auto py-2 py-md-0">
								...
								<a href="Report/kelahiran_rekap.php" target="_BLANK" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i> Rekap Data</a>
...
if (isset($_POST['tambah'])) {
	...
	if (mysqli_num_rows($cek) <= 0) {
		...
		$ins = mysqli_query($k,"INSERT INTO tb_surat (jenis_surat,no_surat,nama_surat,tanggal,isi_surat,tanda_tangan,id_warga,createdon,createdby,rowstatus) VALUES ('SKL','$_POST[nomor_surat]','Surat Keterangan kelahiran',NOW(),'".gantikutip($isiSurat)."','$xttd','$idd',NOW(),'$_SESSION[nama_pegawai]','1')");
		if ($ins) {
...
if (isset($_POST['update'])) {
		...
		$isiSurat = json_encode($isi);
		$xttd = json_encode($ttd); 
		$upd = mysqli_query($k,"UPDATE tb_surat SET jenis_surat='SKL', tanggal=NOW(),  isi_surat='".gantikutip($isiSurat)."', tanda_tangan='$xttd' WHERE id_surat='$update'");
		if ($upd) {
			$id = $update;
			echo "
			<script>
    ...
    $(document).ready(function() {
        tabel =  $('#basic-datatables').DataTable( {
           ...
           "pageLength": 10, 
    		...
    		function pop(id)
    		{ 
		        $('.modal-body').html("<embed  src='Report/kelahiran.php?id="+id+"' width='100%' height='600px' ></embed>");  
