...
<body>
    ...
    <div style="width: 80%; margin-left: 50px;">
        ...
        <br>
        <p class="isi">Benar nama tersebut di atas adalah penduduk ' . desa() . ' ' . kecamatan() . ' ' . kabupaten() . ',  dan telah meninggal dunia, yaitu :</p>
        <table style="margin-left: 70px;">
            <tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td>' . $bio['sebab_kematian'] . '</td>
            </tr>
            <tr>
                <td>Di</td>
                <td>:</td>
                <td>' . $bio['tempat_kematian'] . '</td>
            </tr>
        </table>
...
$mpdf->WriteHTML( $html );
$mpdf->Output( 'SKK_' . $bio['nama'] .'_' . date( 'd-m-Y' ) . '.pdf', 'I' );
?>
