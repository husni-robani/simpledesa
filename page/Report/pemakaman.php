...
<body >
  ...
  <div align="center" style="margin-right: 0px; margin-left: -200px;">
    ...
    <div style="width: 80%; margin-left: 50px;"  >
      ...
      <br>
      <p class="isi"> Nama tersebut di atas benar telah di makamkan pada : </p>
      <table   style="  margin-left: 70px;" >
          <tr>
            <td width="160">Hari, Tanggal Kematian</td>
            <td>:</td>
            <td><?php echo   tanggal_indo(tgl_muter($bio['tgl_kematian'])); ?></td>
          </tr>

          <tr>
            <td width="160">Hari, Tanggal Pemakaman</td>
            <td>:</td>
            <td><?php echo   tanggal_indo(tgl_muter($bio['tgl_kematian'])); ?></td>
          </tr>

          <tr>
            <td width="160">Jam Pemakaman</td>
            <td>:</td>
            <td><?php echo   $bio['jam_pemakaman']; ?></td>
          </tr>   
          <tr>
            <td>Di</td>
            <td>:</td>
            <td><?php echo $bio['tempat_pemakaman']; ?> </td>
          </tr>  
      </table>
