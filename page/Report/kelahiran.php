...
<body >
	...
	<div align="center" style="margin-right: 0px; margin-left: -200px;">
  	...
  	<div style="width: 80%; margin-left: 50px;"  >
  		<p class="isi">Yang bertanda tangan dibawah ini,menerangkan Permohonan kelahiran Penduduk WNI dengan data sebagai berikut  :</p>
  		...
  		<br>
  		<p class="isi">Adapun Permohonan kelahiran Penduduk WNI yang bersangkutan<br>sebagaimana terlampir. </p>
  		<p class="isi">Demikian Surat Pengantar kelahiran ini dibuat agar digunakan sebagaimana mestinya.</p>
