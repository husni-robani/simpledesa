          ...
          <tr>
            ...
            <td><?php echo $bio['pekerjaan']; ?> </td>
  				...
  				<tr>
  					<td>RT/RW</td>
  					<td>:</td>
  					<td><?php echo $bio['rt'].'/'.$bio['rw']; ?> </td>
  				</tr> 
  				
  		</table>
  		<br>
  		<p class="isi">Benar nama tersebut di atas adalah penduduk <?php echo  desa().' '.kecamatan().' '.kabupaten(); ?>  dan menurut sepengetahuan kami yang bersangkutan memiliki Usaha : </p>
<table   style="  margin-left: 70px;" >
  				<tr>
  					<td width="160">Jenis Usaha</td>
  					<td>:</td>
  					<td><?php echo $bio['jenis_usaha']; ?></td>
  				</tr>

  				<tr>
  					<td>Alamat Usaha</td>
  					<td>:</td>
  					<td><?php echo $bio['alamat_usaha']; ?> </td>
  				</tr>  
  		</table>
  		<br>
