...
error_reporting(0);
		...
		header( "Content-disposition: attachment; filename=Rekap-SKU.xls" );  
...
<body  >     
    <div align="center">
        <h3>REKAPITULASI SURAT KETERANGAN USAHA</h3>  
    </div>
    <br> 
    <br> 
                  <table class='table' border="0" width='100%'  >
                   <thead>
						<tr>
							...
							<th class="th">Jenis Usaha</th> 
							<th class="th">Alamat Usaha</th>   
						</tr>
					</thead>  
                     <tbody>
                     	<?php
                     	$no = 1;
                     	$q = mysqli_query($k,"SELECT * FROM tb_surat WHERE jenis_surat='SKU' AND  rowstatus='1' ORDER BY id_surat ASC");
                     	...
                     	<tr>
                     		...
                     		<td class='th'>$bio[jenis_usaha]</td>
                     		<td class='th'>$bio[alamat_usaha]</td> 
						</tr>";
						$no++;
						}
						?>
