...
error_reporting(0);
		...
		header( "Content-disposition: attachment; filename=Rekap-SKK.xls" );  
...
<body  >     
    <div align="center">
        <h3>REKAPITULASI SURAT KETERANGAN KEMATIAN</h3>  
    </div>
    <br> 
    <br> 
                  <table class='table' border="0" width='100%'  >
                   <thead>
                     ...
                     <tbody>
                     	<?php
                     	$no = 1;
                     	$q = mysqli_query($k,"SELECT * FROM tb_surat WHERE jenis_surat='SKK' AND  rowstatus='1' ORDER BY id_surat ASC");
                     	...
                     	<tr>
                     		...
                     		<td class='th'>$bio[sebab_kematian]</td>  
                     		<td class='th'>$bio[tempat_kematian]</td>  
						</tr>";
						$no++;
						}
						?>
