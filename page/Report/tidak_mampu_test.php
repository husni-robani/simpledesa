...
<body>
    ...
    <div style="width: 80%; margin-left: 50px;">
        ...
        <br>
        <p class="isi">Benar nama tersebut di atas adalah penduduk ' . desa() . ' ' . kecamatan() . ' ' . kabupaten() . ', berdasarkan data serta pengetahuan kami bahwa nama tersebut di atas benar keluarga kurang mampu <strong><i>( KELUARGA BERPENGHASILAN RENDAH )</i></strong>. Dan Surat Keterangan ini diberikan untuk keperluan ' . $bio['keperluan'] . '. </p>
...
$mpdf->WriteHTML( $html );
$mpdf->Output( 'SKTM_' . $bio['nama'] .'_' . date( 'd-m-Y' ) . '.pdf', 'I' );
?>
