...
<body >
	...
	<div align="center" style="margin-right: 0px; margin-left: -200px;">
  	...
  	<div style="width: 80%; margin-left: 50px;"  >
  		...
  		<br>
  		<p class="isi">Berdasarkan data kependudukan yang ada di  <?php echo  desa(); ?> bahwa benar yang bersangkutan sampai saat ini masih berdomisili pada alamat tersebut di atas. </p>
