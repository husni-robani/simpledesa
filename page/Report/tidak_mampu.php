...
<body >
  ...
  <div align="center" style="margin-right: 0px; margin-left: -200px;">
    ...
    <div style="width: 80%; margin-left: 50px;"  >
      ...
      <br>
      <p class="isi">Benar nama tersebut di atas adalah penduduk  <?php echo  desa().' '.kecamatan().' '.kabupaten(); ?>, berdasarkan data serta pengetahuan kami bahwa nama tersebut di atas benar keluarga kurang mampu <strong><i>( KELUARGA BERPENGHASILAN RENDAH )</i></strong>. Dan Surat Keterangan ini diberikan untuk keperluan <?php echo $bio['keperluan'] ?>. </p>
