...
error_reporting(0);
		...
		header( "Content-disposition: attachment; filename=Rekap-SKP.xls" );  
...
<body  >     
    <div align="center">
        <h3>REKAPITULASI SURAT KETERANGAN PEMAKAMAN</h3>  
    </div>
    <br> 
    <br> 
                  <table class='table' border="0" width='100%'  >
                   <thead>
						<tr>
							...
							<th class="th">RT</th>  
							<th class="th">RW</th>  
							<th class="th">Tgl Kematian</th>   
							<th class="th">Tgl Pemakaman</th>   
							<th class="th">Tempat Kematian</th>  
						</tr>
					</thead>  
                     <tbody>
                     	<?php
                     	$no = 1;
                     	$q = mysqli_query($k,"SELECT * FROM tb_surat WHERE jenis_surat='SKP' AND  rowstatus='1' ORDER BY id_surat ASC");
                     	while ($d = mysqli_fetch_array($q)) {
							$bio = json_dec($d['isi_surat']);
                     	...
                     	<tr>
                     		...
                     		<td class='th'>$bio[tgl_kematian]</td>      
                     		<td class='th'>$bio[tgl_pemakaman]</td>      
                     		<td class='th'>$bio[tempat_pemakaman]</td>      
						</tr>";
						$no++;
						}
						?>
