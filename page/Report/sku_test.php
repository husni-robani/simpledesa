...
<body>
    ...
    <tr>
        ...
        <td>' . $bio[ 'rt' ] . '/' . $bio[ 'rw' ] . '</td>
            ...
            <br>
            <p class="isi">Benar nama tersebut di atas adalah penduduk ' . desa() . ' ' . kecamatan() . ' ' . kabupaten() . ' dan menurut sepengetahuan kami yang bersangkutan memiliki Usaha : </p>
            <table style="margin-left: 70px;" >
                <tr>
                    <td width="160">Jenis Usaha</td>
                    <td>:</td>
                    <td>' . $bio[ 'jenis_usaha' ] . '</td>
                </tr>
                <tr>
                    <td>Alamat Usaha</td>
                    <td>:</td>
                    <td>' . $bio[ 'alamat_usaha' ] . '</td>
                </tr>
            </table>
            <br>
...
$mpdf->WriteHTML( $html );
$mpdf->Output( 'SKU_'. $bio['nama'] .'_'  . date( 'd-m-Y' ) . '.pdf', 'I' );
?>
