    ...
    <div style="width: 80%; margin-left: 50px;">
        ...
        <table style="margin-left: 70px;">
            ...
            <tr>
                ...
                <td>:</td>
                <td>' . $bio['tempat_lahir'] . ', ' . tanggal_indo(tgl_muter($bio['tgl_lahir'])) . '</td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                <td>:</td>
        ...
        <br>
        <p class="isi">Nama tersebut di atas adalah benar penduduk ' . desa() . ' ' . kecamatan() . ' ' . kabupaten() . ', <br>
        Adapun Surat Keterangan ini dipergunakan sebagai persyaratan izin keramaian pada :</p>
        <table style="margin-left: 70px;">
            <tr>
                <td width="160">Hari, Tanggal Mulai</td>
                <td>:</td>
                <td>' . tanggal_indo(tgl_muter($bio['tgl_mulai'])) . '</td>
            </tr>
            <tr>
                <td width="160">Hari, Tanggal Selesai</td>
                <td>:</td>
                <td>' . tanggal_indo(tgl_muter($bio['tgl_selesai'])) . '</td>
            </tr>
            <tr>
                <td width="160">Acara</td>
                <td>:</td>
                <td>' . $bio['acara'] . '</td>
            </tr>
            <tr>
...
$mpdf->WriteHTML( $html );
$mpdf->Output( 'SIK_' . $bio['nama'] .'_' . date( 'd-m-Y' ) . '.pdf', 'I' );
?>
