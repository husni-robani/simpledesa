...
error_reporting(0);
		...
		header( "Content-disposition: attachment; filename=Rekap-SKKB.xls" );  
...
<body  >     
    <div align="center">
        <h3>REKAPITULASI SURAT KETERANGAN TIDAK MAMPU</h3>  
    </div>
    <br> 
    <br> 
                  <table class='table' border="0" width='100%'  >
                   <thead>
                     ...
                     <tbody>
                     	<?php
                     	$no = 1;
                     	$q = mysqli_query($k,"SELECT * FROM tb_surat WHERE jenis_surat='SKTM' AND  rowstatus='1' ORDER BY id_surat ASC");
