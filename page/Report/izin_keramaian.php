...
<body >
  ...
  <div align="center" style="margin-right: 0px; margin-left: -200px;">
    ...
    <div style="width: 80%; margin-left: 50px;"  >
      ...
      <br>
      <p class="isi"> Nama tersebut di atas adalah benar penduduk <?php echo  desa().' '.kecamatan().' '.kabupaten(); ?>, <br>
      Adapun Surat Keterangan ini dipergunakan sebagai persyaratan izin keramaian pada : </p>
      <table   style="  margin-left: 70px;" >
          <tr>
            <td width="160">Hari, Tanggal Mulai</td>
            <td>:</td>
            <td><?php echo   tanggal_indo(tgl_muter($bio['tgl_mulai'])); ?></td>
          </tr>

          <tr>
            <td width="160">Hari, Tanggal Selesai</td>
            <td>:</td>
            <td><?php echo   tanggal_indo(tgl_muter($bio['tgl_selesai'])); ?></td>
          </tr>

          <tr>
            <td width="160">Acara</td>
            <td>:</td>
            <td><?php echo   $bio['acara']; ?></td>
          </tr>   
          <tr>
            <td>Di</td>
            <td>:</td>
            <td><?php echo $bio['tempat_acara']; ?> </td>
          </tr>  
      </table>
