...
<body >
	...
	<br>
	<p class="isi">Berdasarkan data kependudukan yang ada di ' . desa() . ' bahwa benar yang bersangkutan sampai saat ini masih berdomisili pada alamat tersebut di atas.</p>
...
$mpdf->WriteHTML( $html );
$mpdf->Output( 'SKD_' . $bio['nama'] .'_' . date( 'd-m-Y' ) . '.pdf', 'I' );
?>
