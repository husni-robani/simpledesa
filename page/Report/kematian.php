...
<body >
  ...
  <div align="center" style="margin-right: 0px; margin-left: -200px;">
    ...
    <div style="width: 80%; margin-left: 50px;"  >
      ...
      <br>
      <p class="isi">Benar nama tersebut di atas adalah penduduk  <?php echo  desa().' '.kecamatan().' '.kabupaten(); ?>,  dan telah meninggal dunia, yaitu : </p>
      <table   style="  margin-left: 70px;" >
          <tr>
          ...
          <tr>
            ...
            <td>:</td>
            <td><?php echo $bio['sebab_kematian']; ?> </td>
          </tr>  
          <tr>
            <td>Di</td>
            <td>:</td>
            <td><?php echo $bio['tempat_kematian']; ?> </td>
          </tr>  
      </table>
