...
<body >
  ...
  <div align="center" style="margin-right: 0px; margin-left: -200px;">
    ...
    <div style="width: 80%; margin-left: 50px;"  >
      ...
      <br>
      <p class="isi">Benar nama tersebut di atas adalah penduduk  <?php echo  desa().' '.kecamatan().' '.kabupaten(); ?>, dan sepanjang pengetahuan kami, serta catatan yang ada pada kami bahwa yang bersangkutan belum pernah menikah.</p> 
...
$filename="SKBPM_".date('d-m-Y').".pdf";  
