...
if ($btn=='arsip') {
	...
	$last = mysqli_fetch_array(mysqli_query($k,"SELECT SUBSTRING_INDEX(SUBSTRING_INDEX(no_surat,'/',2),'/',-1)+1 AS nomor FROM tb_surat WHERE jenis_surat='SIK' AND YEAR(tanggal)=YEAR(NOW()) AND rowstatus=1 ORDER BY id_surat DESC LIMIT 1"));
	$next = $last['nomor'] ?? '1';
	$kode_surat = kode_surat(); 
	$nomor = $kode_surat.'/'.$next.'/'.kode_desa().'/SIK/'.getRomawi(DATE('m')).'/'.DATE('Y');
	?>
						...
						<form method="POST" id="form" action="">
								<div class="row">
									...
									<div class="form-group form-inline">
										...
										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Tanggal Mulai</label> 
												<div class="input-group col-md-3">
													<input type="text" id="tgl_kematian" placeholder="dd/mm/yyyy" class="form-control datepicker"  autocomplete="off" name="tgl_mulai">
													<div class="input-group-append">
														<span class="input-group-text">
															<i class="fa fa-calendar-check"></i>
														</span>
										...
										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Tanggal Selesai</label> 
												<div class="input-group col-md-3">
													<input type="text" id="tgl_selesai" placeholder="dd/mm/yyyy" class="form-control datepicker"  autocomplete="off" name="tgl_selesai">
													<div class="input-group-append">
														<span class="input-group-text">
															<i class="fa fa-calendar-check"></i>
														</span>
										...
										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Acara</label> 
												<input type="text" id="acara"  required placeholder="Cth : Nikahan, Hiburan, dll" name="acara" class="col-md-6 form-control"> 
									 	</div> 
										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Tempat Acara</label> 
												<input type="text" id="tempat_acara"  required placeholder="Cth : Lapangan, dll" name="tempat_acara" class="col-md-6 form-control"> 
									 	</div> 
										<hr/>
							...
							<input type="hidden" name="update" value="<?php echo $data['id_surat']; ?>" >
								<div class="row">
									...
									<div class="form-group form-inline">
										...
										<label for="inlineinput" class="col-md-3 col-form-label">Tanggal Mulai</label> 
												<div class="input-group col-md-3">
													<input type="text" id="tgl_kematian" placeholder="dd/mm/yyyy" class="form-control datepicker"  value="<?php echo $bio['tgl_mulai'] ?>" autocomplete="off" name="tgl_mulai">
													<div class="input-group-append">
														<span class="input-group-text">
															<i class="fa fa-calendar-check"></i>
														</span>
										...
										<label for="inlineinput" class="col-md-3 col-form-label">Tanggal Selesai</label> 
												<div class="input-group col-md-3">
													<input type="text" id="tgl_selesai" placeholder="dd/mm/yyyy" class="form-control datepicker"  value="<?php echo $bio['tgl_selesai'] ?>" autocomplete="off" name="tgl_selesai">
													<div class="input-group-append">
														<span class="input-group-text">
															<i class="fa fa-calendar-check"></i>
														</span>
										...
										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Acara</label> 
												<input type="text" id="acara"  value="<?php echo $bio['acara'] ?>"  required placeholder="Cth : Nikahan, Hiburan, dll" name="acara" class="col-md-6 form-control"> 
									 	</div> 
										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Tempat Acara</label> 
												<input type="text" id="tempat_acara"  value="<?php echo $bio['tempat_acara'] ?>"  required placeholder="Cth : Lapangan, dll" name="tempat_acara" class="col-md-6 form-control"> 
									 	</div> 
										<hr/>
...
$data = array();
if (@$jenis=='arsip') {
	$qry = mysqli_query($k,"SELECT * FROM tb_surat WHERE jenis_surat='SIK' AND arsip='1' AND rowstatus='1'");  

}else{
$qry = mysqli_query($k,"SELECT * FROM tb_surat WHERE jenis_surat='SIK' AND arsip is null AND rowstatus='1'");  
   ...
   $jsonResult = '{"data" : '; 
   	while ($d = mysqli_fetch_array($qry)) {
		...
		$data['tgl_mulai']			= $isi['tgl_mulai'];  
		$data['tgl_selesai']		= $isi['tgl_selesai'];  
		$data['acara']				= $isi['acara'];  
		$data['tempat_acara']		= $isi['tempat_acara'];  
		$data['id']					= $d['id_surat'];
		array_push($res, $data);
		$no++;
...
<script type="text/javascript">
    ...
    $(document).ready(function() { 
        tabel =  $('#basic-arsip').DataTable( {
            ...
            "ajax":
            {
                "url": "Ajax/izin_keramaian.php", // URL file untuk proses select datanya
                "type": "POST",
                "data": {
                	"btn":'tabel',
                	"jenis" : 'arsip'
