...
if ($btn=='arsip') {
	...
	$last = mysqli_fetch_array(mysqli_query($k,"SELECT SUBSTRING_INDEX(SUBSTRING_INDEX(no_surat,'/',2),'/',-1)+1 AS nomor FROM tb_surat WHERE jenis_surat='SKK' AND YEAR(tanggal)=YEAR(NOW()) AND rowstatus=1 ORDER BY id_surat DESC LIMIT 1"));
	$next = $last['nomor'] ?? '1';
	$kode_surat = kode_surat(); 
	$nomor = $kode_surat.'/'.$next.'/'.kode_desa().'/SKP/'.getRomawi(DATE('m')).'/'.DATE('Y');
	?>
						...
						<form method="POST" id="form" action="">
								<div class="row">
									...
									<div class="form-group form-inline">
										...
										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Tanggal Kematian</label> 
												<div class="input-group col-md-3">
													<input type="text" id="tgl_kematian" placeholder="dd/mm/yyyy" class="form-control datepicker"  autocomplete="off" name="tgl_kematian">
													<div class="input-group-append">
														<span class="input-group-text">
															<i class="fa fa-calendar-check"></i>
														</span>
										...
										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Tanggal Pemakaman</label> 
												<div class="input-group col-md-3">
													<input type="text" id="tgl_pemakaman" placeholder="dd/mm/yyyy" class="form-control datepicker"  autocomplete="off" name="tgl_pemakaman">
													<div class="input-group-append">
														<span class="input-group-text">
															<i class="fa fa-calendar-check"></i>
														</span>
										...
										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Jam Pemakaman</label> 
												<div class="input-group col-md-3">
													<input type="text" id="jam_pemakaman" placeholder="JJ:MM" class="form-control timepicker"  autocomplete="off" name="jam_pemakaman">
													<div class="input-group-append">
														<span class="input-group-text">
															<i class="fa fa-calendar-check"></i>
														</span>
										...
										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Tempat Pemakaman</label> 
												<input type="text" id="tempat_pemakaman"  required placeholder="Cth : Alamat TPU, dll" name="tempat_pemakaman" class="col-md-6 form-control"> 
									 	</div> 
										<hr/>
							...
							<input type="hidden" name="update" value="<?php echo $data['id_surat']; ?>" >
								<div class="row">
									...
									<div class="form-group form-inline">
										...
										<label for="inlineinput" class="col-md-3 col-form-label">Tanggal Kematian</label> 
												<div class="input-group col-md-3">
													<input type="text" id="tgl_kematian"   value="<?php echo $bio['tgl_kematian'] ?>"  placeholder="dd/mm/yyyy" class="form-control datepicker"  autocomplete="off" name="tgl_kematian">
													<div class="input-group-append">
														<span class="input-group-text">
															<i class="fa fa-calendar-check"></i>
														</span>
										...
										<label for="inlineinput" class="col-md-3 col-form-label">Tanggal Pemakaman</label> 
												<div class="input-group col-md-3">
													<input type="text" id="tgl_pemakaman" placeholder="dd/mm/yyyy" class="form-control datepicker" value="<?php echo $bio['tgl_pemakaman'] ?>"   autocomplete="off" name="tgl_pemakaman">
													<div class="input-group-append">
														<span class="input-group-text">
															<i class="fa fa-calendar-check"></i>
														</span>
										...
										<label for="inlineinput" class="col-md-3 col-form-label">Jam Pemakaman</label> 
												<div class="input-group col-md-3">
													<input type="text" id="jam_pemakaman" value="<?php echo $bio['jam_pemakaman'] ?>"  placeholder="JJ:MM" class="form-control timepicker"  autocomplete="off" name="jam_pemakaman">
													<div class="input-group-append">
														<span class="input-group-text">
															<i class="fa fa-calendar-check"></i>
														</span>
										...
										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Tempat Pemakaman</label> 
												<input type="text" id="tempat_pemakaman" value="<?php echo $bio['tempat_pemakaman'] ?>"  required placeholder="Cth : Alamat TPU, dll" name="tempat_pemakaman" class="col-md-6 form-control"> 
									 	</div> 
										<hr/> 
...
$data = array();
if ($jenis=='arsip') {
	$qry = mysqli_query($k,"SELECT * FROM tb_surat WHERE jenis_surat='SKP' AND arsip='1' AND rowstatus='1'");  

}else{
$qry = mysqli_query($k,"SELECT * FROM tb_surat WHERE jenis_surat='SKP' AND arsip is null AND rowstatus='1'");  

}

   $jsonResult = '{"data" : '; 
   	while ($d = mysqli_fetch_array($qry)) {
   		$isi = json_dec($d['isi_surat']); 
		...
		$data['tgl_kematian']		= $isi['tgl_kematian'];  
		$data['tgl_pemakaman']		= $isi['tgl_pemakaman'];  
		$data['jam_pemakaman']		= $isi['jam_pemakaman'];  
		$data['tempat_pemakaman']	= $isi['tempat_pemakaman'];  
		$data['id']					= $d['id_surat'];
		array_push($res, $data);
		$no++;
