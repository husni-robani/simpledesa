...
if ($btn=='arsip') {
	...
	$nomor = $kode_surat.'/'.$next.'/'.kode_desa().'/SKK/'.getRomawi(DATE('m')).'/'.DATE('Y');
	?>
						...
						<form method="POST" id="form" action="">
								<div class="row">
									...
									<div class="form-group form-inline">
										...
										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Sebab Kematian</label> 
												<input type="text" id="sebab_kematian"  required placeholder="Cth : Sakit,Kecelakaan dll" name="sebab_kematian" class="col-md-6 form-control"> 
									 	</div> 

										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Tempat Kematian</label> 
												<input type="text" id="tempat_kematian"  required placeholder="Cth : Alamat Rumah, Rumah Sakit, dll" name="tempat_kematian" class="col-md-6 form-control"> 
									 	</div> 
										<hr/>
							...
							<input type="hidden" name="update" value="<?php echo $data['id_surat']; ?>" >
								<div class="row">
									...
									<div class="form-group form-inline">
										...
										<label for="inlineinput" class="col-md-3 col-form-label">Tanggal Kematian</label> 
												<div class="input-group col-md-3">
													<input type="text" id="tgl_kematian" placeholder="dd/mm/yyyy" class="form-control datepicker"   value="<?php echo $bio['tgl_kematian'] ?>"   autocomplete="off" name="tgl_kematian">
													<div class="input-group-append">
														<span class="input-group-text">
															<i class="fa fa-calendar-check"></i>
														</span>
										...
										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Sebab Kematian</label> 
												<input type="text" id="sebab_kematian"   value="<?php echo $bio['sebab_kematian'] ?>"   required placeholder="Cth : Sakit,Kecelakaan dll" name="sebab_kematian" class="col-md-6 form-control"> 
									 	</div> 

										<div class="form-group form-inline">
										<label for="inlineinput" class="col-md-3 col-form-label">Tempat Kematian</label> 
												<input type="text" id="tempat_kematian"   value="<?php echo $bio['tempat_kematian'] ?>"   required placeholder="Cth : Alamat Rumah, Rumah Sakit, dll" name="tempat_kematian" class="col-md-6 form-control"> 
									 	</div> 
										<hr/> 
...
$data = array();
if ($jenis=='arsip') {
	$qry = mysqli_query($k,"SELECT * FROM tb_surat WHERE jenis_surat='SKK' AND arsip='1' AND rowstatus='1'");  

}else{
$qry = mysqli_query($k,"SELECT * FROM tb_surat WHERE jenis_surat='SKK' AND arsip is null AND rowstatus='1'");  
   ...
   $jsonResult = '{"data" : '; 
   	while ($d = mysqli_fetch_array($qry)) {
		...
		$data['sebab_kematian']		= $isi['sebab_kematian']; 
		$data['id']					= $d['id_surat'];
		array_push($res, $data);
		$no++;
...
<script type="text/javascript">
    ...
    $(document).ready(function() { 
        tabel =  $('#basic-arsip').DataTable( {
            ...
            "ajax":
            {
                "url": "Ajax/kematian.php", // URL file untuk proses select datanya
                "type": "POST",
                "data": {
                	"btn":'tabel',
                	"jenis" : 'arsip'
